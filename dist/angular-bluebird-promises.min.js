 ...
 * @license MIT
 */
!function(n,e){"use strict";n.module("mwl.bluebird",[]).constant("Bluebird",e.P.noConflict()).config(["$provide","Bluebird",function(e,r){r.defer=function(){var e=r.pending();return e.resolve=n.bind(e,e.fulfill),e.reject=n.bind(e,e.reject),e.notify=n.bind(e,e.progress),e},r.reject=r.rejected,r.when=r.cast;var o=r.all;r.all=function(e){return n.isObject(e)&&!n.isArray(e)?r.props(e):o.call(r,e)},r.onPossiblyUnhandledRejection(n.noop),e.decorator("$q",function(){return r})}]).run(["$rootScope","Bluebird",function(n,e){e.setScheduler(function(e){n.$evalAsync(e)})}])}(angular,window);
